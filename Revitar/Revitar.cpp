...
switch (index)
  ...
  case kChordOnOff :
    ...
    if (prog.fChordOnOff > 0.f)
      prog.fMono = ap->fMono = 0.f;
    break;
  case kSustain :   prog.fSustain = ap->fSustain = value; break;
  case kPickNoise :   prog.fPickNoise = ap->fPickNoise = value; break;
  case kChord : 
    if (bAbsRel)
  ...
  case kChordAbs : 
    if (!bAbsRel)
      ...
      prog.fChordAbsIdx = ap->fChordAbsIdx = value;
    break;
  case kChordSwitch : prog.fChordSwitch = ap->fChordSwitch = value; break;
  case kBodySwitch : prog.fBodySwitch = ap->fBodySwitch = value; break;
  case kChordNote0 :  
  case kChordNote1 :  
  case kChordNote2 :  
  case kChordNote3 :  
  ...
  case kChordNote5 :  
    ...
    break;
  case kPickPosition :    prog.fPickPosition = ap->fPickPosition = value; break;
  case kPickUp :  prog.fPickUp = ap->fPickUp = value; break;
  case kPickStiffness :   prog.fPickStiffness = ap->fPickStiffness = value; break;
  case kPickWidth :   prog.fPickWidth = ap->fPickWidth = value; break;
  case kPalmSlider :  prog.fPalmSlider = ap->fPalmSlider = value; break;
  case kAbsRel :  prog.fAbsRel = ap->fAbsRel = value; break;
  case kStopSwitch :  prog.fStopSwitch = ap->fStopSwitch = value; break;
...
switch (index)
  ...
  case kKnobSlideRate :     
    v = prog.fKnob[index];
    break;
  case kMono :    v = prog.fMono; break;
  case kChordOnOff :    v = prog.fChordOnOff; break;
  case kSustain :    v = prog.fSustain; break;
  case kPickNoise :  v = prog.fPickNoise; break;
  case kChord :    v = (bAbsRel)  ? prog.fChordIdx : prog.fChordAbsIdx; break;
  case kChordAbs : v = (!bAbsRel) ? prog.fChordIdx : prog.fChordAbsIdx; break;
  case kChordSwitch : v = prog.fChordSwitch; break;
  case kBodySwitch :  v = prog.fBodySwitch; break;
  case kChordNote0 :  
  case kChordNote1 :  
  case kChordNote2 :  
  case kChordNote3 :  
  ...
  case kChordNote5 :  
    ...
    break;
  case kPickPosition :    v = prog.fPickPosition; break;
  case kPickUp :  v = prog.fPickUp; break;
  case kPickWidth :   v = prog.fPickWidth; break;
  case kPickStiffness :   v = prog.fPickStiffness; break;
  case kPalmSlider :  v = prog.fPalmSlider; break;
  case kAbsRel :  v = prog.fAbsRel; break;
  case kStopSwitch :  v = prog.fStopSwitch; break;
...
switch (index)
  {
  case kKnobGain :          strcpy (label, " Gain "); break;
  case kKnobBodyGain :      strcpy (label, " Body Gain "); break;
  case kKnobPickVolume :    strcpy (label, " Pick Volume "); break;
  case kKnobTuning :        strcpy (label, " Tune "); break;
  case kKnobBridgeDamping : strcpy (label, " Bridge Damp "); break;
  case kKnobStringDamping : strcpy (label, " String Damp "); break;
  case kKnobVibratoAmplit : strcpy (label, " Vibrato Amp "); break;
  case kKnobVibratoRate :   strcpy (label, " Vibrato Rate "); break;
  case kKnobSympathetic :   strcpy (label, " Sympathetic "); break;
  case kKnobSlap :          strcpy (label, " Slap "); break;
  case kKnobPickSpeed :     strcpy (label, " Pick Speed "); break;
  case kKnobChordRate :     strcpy (label, " Chord Rate "); break;
  case kKnobStringType :    strcpy (label, " String Type "); break;
  case kKnobPalmDamp :      strcpy (label, " Palm Damp "); break;
  case kKnobSlideRate :     strcpy (label, " Slide Rate "); break;
    
  case kMono :              strcpy (label, " Mono "); break;
  case kSustain :           strcpy (label, " Sustain "); break;
  case kChordOnOff :        strcpy (label, " Chord Play On/Off "); break;
  case kChord :             strcpy (label, " Chord Type "); break;
  case kChordAbs :          strcpy (label, " Chord Type "); break;
  case kChordSwitch :       strcpy (label, " Strum Direction "); break;
  case kBodySwitch :        strcpy (label, " Body Type "); break;
  case kPickNoise :         strcpy (label, " Pluck Noise "); break;
  case kChordNote0 :
  case kChordNote1 :
  case kChordNote2 :
  case kChordNote3 :
  case kChordNote4 :
  case kChordNote5 :        sprintf (label, " Chord Note %d ", index - kChordNote0); break;

  case kPalmSlider :        strcpy (label, " Palm Position "); break;
  case kPickPosition :      strcpy (label, " Pick Position "); break;
  case kPickUp :            strcpy (label, " Pick Up Position "); break;
  case kPickWidth :         strcpy (label, " Pick Width "); break;
  case kPickStiffness :     strcpy (label, " Pick Stiffness "); break;
  case kAbsRel :            strcpy (label, " Absolute/Relative Position "); break;
  case kStopSwitch :        strcpy (label, " Stop Strings "); break;
...
switch (index)
  ...
  case kChordOnOff :    float2string (prog.fChordOnOff, text, kVstMaxParamStrLen); break;
  case kMono :          float2string (prog.fMono, text, kVstMaxParamStrLen); break;
  case kSustain :       float2string (prog.fSustain, text, kVstMaxParamStrLen); break;
  case kPickNoise :     float2string (prog.fPickNoise, text, kVstMaxParamStrLen); break;
  case kChord :         float2string (prog.fChordIdx, text, kVstMaxParamStrLen); break;
  case kChordAbs :      float2string (prog.fChordAbsIdx, text, kVstMaxParamStrLen); break;
  case kChordSwitch :   float2string (prog.fChordSwitch, text, kVstMaxParamStrLen); break;
  case kBodySwitch :    float2string (prog.fBodySwitch, text, kVstMaxParamStrLen); break;
  case kChordNote0 :
  case kChordNote1 :
  case kChordNote2 :
  case kChordNote3 :
  ...
  case kPalmSlider :    float2string (prog.fPalmSlider, text, kVstMaxParamStrLen); break;
  case kPickPosition :  float2string (prog.fPickPosition, text, kVstMaxParamStrLen); break;
  case kPickUp :        float2string (prog.fPickUp, text, kVstMaxParamStrLen); break;
  case kPickWidth :     float2string (prog.fPickWidth, text, kVstMaxParamStrLen); break;
  case kPickStiffness : float2string (prog.fPickStiffness, text, kVstMaxParamStrLen); break;
  case kAbsRel :        float2string (prog.fAbsRel, text, kVstMaxParamStrLen); break;
  case kStopSwitch :    float2string (prog.fStopSwitch, text, kVstMaxParamStrLen); break;
...
switch (index)
  ...
  case kMono :              strcpy (label, " Mono/Poly ");  break;
  case kSustain :           strcpy (label, " Sustain "); break;
  case kChordOnOff :        strcpy (label, " Chord Play On/Off ");    break;
  case kChord :             strcpy (label, " Chord Type ");    break;
  case kChordAbs :          strcpy (label, " Chord Type "); break;
  case kChordSwitch :       strcpy (label, " Strum Direction "); break;
  case kBodySwitch :        strcpy (label, " Body Type ");    break;
  case kPickNoise :         strcpy (label, " Pluck Noise Full/Reduced "); break;
  case kChordNote0 :
  case kChordNote1 :
  case kChordNote2 :
  case kChordNote3 :
  case kChordNote4 :
  case kChordNote5 :        strcpy (label, (prog.fAbsRel > 0.f) ? " Fret# " : " Note "); break;
  case kPalmSlider :        strcpy (label, " Palm Position "); break;
  case kPickPosition :      strcpy (label, " Pick Position "); break;
  case kPickUp :            strcpy (label, " Pick Up Position "); break;
  case kPickWidth :         strcpy (label, " Pick Width "); break;
