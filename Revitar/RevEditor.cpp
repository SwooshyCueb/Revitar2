...
switch (lastIndex)
  {
  case kKnobGain :          sprintf(string, " Gain ");    break;
  case kKnobBodyGain :      sprintf(string, " Body Gain ");   break;
  case kKnobPickVolume :    sprintf(string, " Pick Volume "); break;
  case kKnobTuning :        sprintf(string, " Tune ");    break;
  case kKnobBridgeDamping : sprintf(string, " Bridge Damping ");  break;
  case kKnobStringDamping : sprintf (string, " String Damping "); break;
  case kKnobVibratoAmplit : sprintf (string, " Vibrato Amplitude ");   break;
  case kKnobVibratoRate :   sprintf (string, " Vibrato Rate ");    break;
  case kKnobSympathetic :   sprintf (string, " Sympathetic "); break;
  case kKnobSlap :          sprintf (string, " Slap ");    break;
  case kKnobPickSpeed :     sprintf (string, " Pick Speed "); break;
  case kKnobChordRate :     sprintf (string, " Chord Rate "); break;
  case kKnobStringType :    sprintf (string, " String Type ");    break;
  case kKnobPalmDamp :      sprintf (string, " Palm Damping ");   break;
  case kKnobSlideRate :     sprintf (string, (value > 0.2) ? " Slide Rate " : " Hammer / Pull "); break;
  case kMono :              sprintf (string, (value < 0.5f) ? " Polyphonic " : " Monophonic "); break;
  case kAbsRel :            sprintf (string, (value < 0.5f) ? " Absolute " : " Relative "); break;
  case kSustain :           sprintf (string, " Sustain ");   break;
  case kPickNoise :         sprintf (string, " Pluck Noise ");   break;
  case kChord :             sprintf (string, " Chord Type ");  break;
  case kChordSwitch :       sprintf (string, " Strum Direction ");   break;
  case kBodySwitch :        sprintf (string, " Body Type ");  break;
  case kChordOnOff :        sprintf (string, " Chord Play "); break;
  case kPickSwitch :        sprintf (string, " Pick Width "); break;
  case kPickUp :            sprintf (string, " Pick Up Position "); break;
  case kPickPosition :      sprintf (string, " Pick Position "); break;
  case kChordNote0 :        sprintf (string, " Chord Note 0 "); break;
  case kChordNote1 :        sprintf (string, " Chord Note 1 "); break;
  case kChordNote2 :        sprintf (string, " Chord Note 2 "); break;
  case kChordNote3 :        sprintf (string, " Chord Note 3 "); break;
  case kChordNote4 :        sprintf (string, " Chord Note 4 "); break;
  case kChordNote5 :        sprintf (string, " Chord Note 5 "); break;
  case kPalmSlider :        sprintf (string, " Palm Position "); break;
...
switch (lastIndex)
  {
  case kKnobGain :          sprintf(string, " %1.2f ", value);  break;
  case kKnobBodyGain :      sprintf(string, " %1.2f ", value);  break;
  case kKnobPickVolume :    sprintf(string, " %1.2f ", value);    break;
  case kKnobTuning :        sprintf(string, " %d cents ", (int) (200.0*value - 100.0)); break;
  case kKnobBridgeDamping : sprintf(string, " %1.2f ", value); break;
  case kKnobStringDamping : sprintf(string, " %1.2f ", value); break;
  case kKnobVibratoAmplit : sprintf(string, " %1.2f ", value); break;
  case kKnobVibratoRate :   sprintf(string, " %1.2f ", value); break;
  case kKnobSympathetic :   sprintf(string, " %1.2f ", value); break;
  case kKnobSlap :          sprintf(string, " %1.2f ", value); break;
  case kKnobPickSpeed :     sprintf(string, " %1.2f ", value);    break;
  case kKnobChordRate :     sprintf(string, " %1.2f ", value);    break;
  case kKnobStringType :    sprintf(string, " %1.2f ", value);    break;
  case kKnobPalmDamp :      sprintf(string, " %1.2f ", value);    break;
  case kKnobSlideRate :     sprintf(string, " %1.2f ", (value > 0.2f) ? (value - 0.2f) / 0.8f : 5.0f * (0.2f - value)); break;
  case kPalmSlider :        sprintf(string, " %1.2f ", value);    break;
  case kPickPosition :      sprintf(string, " %1.2f ", value);  break;
  case kPickUp :            sprintf(string, " %1.2f ", value);    break;
  case kPickSwitch :        sprintf(string, " and Stiffness "); break;
  case kAbsRel :            sprintf(string, " Position "); break;
  case kChordNote0 :  
  case kChordNote1 :    
  case kChordNote2 :    
  case kChordNote3 :    
