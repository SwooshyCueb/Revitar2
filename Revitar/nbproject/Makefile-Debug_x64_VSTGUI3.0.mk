...
LDLIBSOPTIONS=vstsdk2.4/dist/Debug_x64/MinGW+w64-Windows/libvst-2.4.2.a vstsdk2.4/vstgui.sf/dist/Debug_x64/MinGW+w64-Windows/libvstgui-3.0.a rcf.o -mwindows

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libRevitar.${CND_DLIB_EXT}

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libRevitar.${CND_DLIB_EXT}: vstsdk2.4/dist/Debug_x64/MinGW+w64-Windows/libvst-2.4.2.a

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libRevitar.${CND_DLIB_EXT}: vstsdk2.4/vstgui.sf/dist/Debug_x64/MinGW+w64-Windows/libvstgui-3.0.a
...
.build-subprojects:
	...
	cd vstsdk2.4/vstgui.sf && ${MAKE}  -f Makefile CONF=Debug_x64
...
.clean-subprojects:
	...
	cd vstsdk2.4/vstgui.sf && ${MAKE}  -f Makefile CONF=Debug_x64 clean
